                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content rounded-4 shadow">
                        ...
                        <div class="modal-footer bg-white rounded-bottom-4 d-flex justify-content-between px-4 py-3">
                            <asp:Button ID="btnRegistrarDueño" runat="server" ValidationGroup="registrarDueño" Text="Registrar" CssClass="btn btn-success btn-lg px-4 rounded-pill" CausesValidation="true" OnClick="btnRegistro_Click" />
